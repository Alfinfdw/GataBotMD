...
//await m.reply(`Humanz wa.me/6288804947282`)  
const data = global.owner.filter(([id, isCreator]) => id && isCreator)
await conn.sendContact(m.chat, data.map(([id, name]) => [id, name]), m)
  
let pp = './media/menus/Menu2.jpg'
let str = `${wm}`
let oficial = 'Aku ganteng'

await conn.sendHydrated2(m.chat, str, oficial, pp, 'https://github.com/GataNina-Li/GataBot-MD', '𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿', 'https://www.instagram.com/humanzzhengker', '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', [
['𝙂𝙤 𝙩𝙤 Menu', '/menu'],
], m,)
}
